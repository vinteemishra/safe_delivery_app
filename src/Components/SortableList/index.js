...
export default class SortableList extends Component {
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }} ref={this._onRefContainer}>
        {this._renderRows()}
      </View>
    );
  }
  ...
  _renderRows() {
    ...
    if (rowsLayouts) {
      Object.keys(rowsLayouts).forEach((key) => {
        // console.log('rowsLayout', key, rowsLayouts[key])
